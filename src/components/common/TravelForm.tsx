...
const TravelForm: React.FC = () => {
  ...
  const handleBack = () => setShowQuoteForm(false);
  ...
  const handleConfirm = () => {
    if (!selectedCard) {
      setErrors((prev) => ({
        ...prev,
        plan: "Please select an insurance plan.",
      }));
      return;
    }
    if (validateForm()) setShowQuoteForm(true);
  };
  ...
  return (
    <>
      <div className="w-full bg-[#f0f5fa] min-h-screen">
        <div className="w-full px-4 md:px-10 lg:px-10 xl:px-16 2xl:px-18 py-8">
          <div className="flex flex-col md:flex-row mt-10 mb-10 p-6 md:p-8 gap-6 md:gap-10 rounded-lg bg-white shadow-sm">
            ...
            <div className="flex-1 bg-white rounded-lg shadow p-6 md:p-8 flex flex-col justify-center">
              ...
              <div className="space-y-3 mb-5">
                ...
                <div className="relative">
                  <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                    <span className="text-red-600">*</span>  Trip Date
                  </label>
                  <input
                    type="text"
                    readOnly
                ...
                {/* Passengers */}
                <div>
                   <label className="block text-xm font-semibold text-gray-700 mb-1.5">
                    <span className="text-red-600">*</span>   Passengers
                  </label>
                  <select
                    name="passengers"
              ...
              {/* Travel Takaful Toggle – ARROWS UPDATED */}
              <div
        ...
        {showPlans && (
  <div className="max-w-7xl mx-auto px-12 mt-12 mb-12 min-h-screen">
