...
// interface CarTakafulQuoteProps {
//   formData: FormData;
//   selectedQuote: InsuranceQuote;
//   onBack: () => void;
// }

// const CarTakafulQuote: React.FC<CarTakafulQuoteProps> = ({
//   formData,
//   selectedQuote,
//   onBack,
// }) => {
...
//   return (
//     // UPDATED: px-12 + max-w-7xl mx-auto
...
//                 <button
//                   onClick={onBack}
//                   className="border border-gray-300 rounded-md px-6 py-2 text-gray-700 hover:bg-gray-100"
//                 >
//                   Previous Step
//                 </button>
//                 <button
//                   onClick={handleSubmit}
//                   className="bg-[#1A3970] text-white rounded-md px-8 py-2 hover:bg-[#2A4D8F]"
//                 >
//                   Confirm
//                 </button>
//               </div>
...
// export default CarTakafulQuote;
