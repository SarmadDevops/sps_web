...
//       description:
//         "Car service is essential for maintaining performance and longevity of vehicle. From oil changes, Dominion lowe there light she does lights begning subdue.",
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 py-16 px-4 sm:px-6 lg:px-8">
