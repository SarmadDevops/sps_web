...
//               value={formData.cc}
//               onChange={handleChange}
//               className={`w-full border ${errors.cc ? "border-red-500" : "border-gray-300"} rounded-md px-12 py-3 pr-12 appearance-none bg-white focus:ring-2 focus:ring-[#1A3970] outline-none cursor-pointer`}
//             >
...
//               onChange={handleChange}
//               className={`w-full border ${errors.model ? "border-red-500" : "border-gray-300"} rounded-md px-12 py-3 pr-12 appearance-none bg-white focus:ring-2 focus:ring-[#1A3970] outline-none cursor-pointer`}
//             >
...
//               } rounded-md px-12 py-3 pr-12 cursor-pointer bg-white focus:ring-2 focus:ring-[#1A3970] outline-none`}
//             />
//           </InputWithIcon>
...
//             className={`w-full border ${errors.currentValue ? "border-red-500" : "border-gray-300"} rounded-md px-12 py-3 focus:ring-2 focus:ring-[#1A3970] outline-none`}
//           />
...
//           className="bg-[#1A3970] text-white px-12 py-3 rounded-md hover:bg-[#2A4D8F] transition"
//         >
//           Check Info
//         </button>
//       </div>
